...
static constexpr int ENGINE_COUNT = 4;
...
static EngineCommand g_engineCommands[ENGINE_COUNT];
...
static SettingsBuffer g_settings = {
	.names = g_settingNames,
	.values = g_settingValues,
	.count = sizeof(g_settingValues) / sizeof(float*)
};
...
DRONE_API void update(
	...
	outCommands->commands = g_engineCommands;
